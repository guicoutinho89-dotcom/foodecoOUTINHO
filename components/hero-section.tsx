  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center bg-foodco-white text-center py-12 px-4 md:px-6 lg:py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-8 text-left">
        ...
        <div className="mb-4">
          <img src="/images/foodco-logo-updated.png" alt="Food&Co Logo" className="h-16 sm:h-20 md:h-24 mr-auto" />
        </div>
        ...
        {/* Subheadline */}
        <p className="ml-0 max-w-2xl text-lg text-gray-700 md:text-xl lg:text-2xl">
        ...
        <a
          ...
          className="inline-flex items-center justify-center rounded-full bg-foodco-orange px-8 py-3 text-lg font-bold text-foodco-white shadow-lg transition-all duration-300 ease-in-out hover:bg-foodco-orange/90 transform hover:scale-105"
        >
        ...
        <div className="flex justify-start gap-6 mt-12 flex-wrap">
          <div className="flex flex-col items-center text-gray-600">
            <Utensils className="w-10 h-10 md:w-12 md:h-12 text-foodco-orange" />
            <span className="text-sm mt-1">Gourmet</span>
          </div>
          <div className="flex flex-col items-center text-gray-600">
            <Sushi className="w-10 h-10 md:w-12 md:h-12 text-foodco-orange" />
            <span className="text-sm mt-1">Japonesa</span>
          </div>
          <div className="flex flex-col items-center text-gray-600">
            <Pizza className="w-10 h-10 md:w-12 md:h-12 text-foodco-orange" />
            <span className="text-sm mt-1">Italiana</span>
          </div>
          <div className="flex flex-col items-center text-gray-600">
            <Burger className="w-10 h-10 md:w-12 md:h-12 text-foodco-orange" />
            <span className="text-sm mt-1">Americana</span>
          </div>
          <div className="flex flex-col items-center text-gray-600">
            <Coffee className="w-10 h-10 md:w-12 md:h-12 text-foodco-orange" />
            <span className="text-sm mt-1">Cafeteria</span>
          </div>
        </div>
      </div>
    </section>
