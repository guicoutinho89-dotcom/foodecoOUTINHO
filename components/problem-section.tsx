        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <Card className="flex flex-col items-center p-6 text-center shadow-lg rounded-lg">
            <CardHeader className="pb-4">
              <DollarSignOff className="w-16 h-16 text-foodco-orange mb-4" />
          ...
          <Card className="flex flex-col items-center p-6 text-center shadow-lg rounded-lg">
            <CardHeader className="pb-4">
              <Clock className="w-16 h-16 text-foodco-orange mb-4" />
              <CardTitle className="text-xl font-semibold text-gray-800">⏰ Esperar 1h+ Por Decepção</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-gray-600">
          ...
          <Card className="flex flex-col items-center p-6 text-center shadow-lg rounded-lg">
            <CardHeader className="pb-4">
              <Meh className="w-16 h-16 text-foodco-orange mb-4" />
              <CardTitle className="text-xl font-semibold text-gray-800">😔 Se Resignar com "É o que Tem"</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-gray-600">
