      ...
      <div className="container mx-auto max-w-5xl space-y-12">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="p-6 shadow-lg rounded-lg bg-gray-50">
              <CardContent className="flex flex-col items-center text-center p-0">
                <Avatar className="w-16 h-16 mb-4">
                  <AvatarFallback className="bg-foodco-orange text-foodco-white text-xl font-bold">
        ...
        <div className="mt-16 space-y-8">
          <h3 className="text-2xl font-bold tracking-tighter text-gray-900 sm:text-3xl">Números de Credibilidade</h3>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {credibilityNumbers.map((item, index) => (
              <div key={index} className="flex flex-col items-center">
                <p className="text-5xl font-bold text-foodco-orange">{item.value}</p>
